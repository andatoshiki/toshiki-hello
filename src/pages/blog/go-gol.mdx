...
![demo](https://github.com/toshiki/go-gol/raw/main/images/demo.gif?raw=true)
...
```bash
go mod init github.com/toshiki/go-gol
```
...
All the code can be found [here](https://github.com/toshiki/go-gol).
