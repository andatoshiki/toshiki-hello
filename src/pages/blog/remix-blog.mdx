...
You will see a very basic app like this ![bootstrapped-app](https://us-east-1.tixte.net/uploads/toshiki.needs.rest/brave_3mwe2bD2OG.png)
...
Now if you navigate to `http://localhost:3000/blog/first-blog`, you should see the markdown being rendered there. ![first-blog](https://us-east-1.tixte.net/uploads/toshiki.needs.rest/brave_VoZNWNDC7F.png)
...
Now navigate to `/blog/first-blog` and you should see the title and date being rendered. ![attributes](https://us-east-1.tixte.net/uploads/toshiki.needs.rest/brave_eaPYVVzuR2.png) Also notice how the `meta` tag that we added to out markdown gave the page a title.

<br />

Now let's paste an actual blog post in here. You can write your own blog. If you
don't have a blog prepared, for now you can just copy [this blog](https://raw.githubusercontent.com/toshiki/remix-blog/main/app/routes/blog/go-gol.mdx)
to follow along.

<br />
So you should have a whole blog being rendered like this. ![blog-without-styling](https://us-east-1.tixte.net/uploads/toshiki.needs.rest/brave_n8aPAVElD8.gif)
...
export const meta: MetaFunction = () => {
  return {
    ...
    description: "here toshiki writes about stuff",
  };
};
...
Now if you rerun your dev server by using `npm run dev`, you will see that our syntax highlighting works! ![syntax-highlighting](https://us-east-1.tixte.net/uploads/toshiki.needs.rest/brave_sOaQ8ZJoYH.png)
...
We are also centering it using flexbox. Just one `prose` class and it makes it so much better! ![typography](https://us-east-1.tixte.net/uploads/toshiki.needs.rest/brave_umo6KZ1WSu.gif)
...
Now if you go to `/blog` you will see, that all our posts are shown there. ![/blog](https://us-east-1.tixte.net/uploads/toshiki.needs.rest/brave_EsooUIZfZD.png)
...
![landing](https://us-east-1.tixte.net/uploads/toshiki.needs.rest/brave_Tj44rGk8Vx.png)
...
![vercel-import](https://us-east-1.tixte.net/uploads/toshiki.needs.rest/brave_wmScEKFQZ4.png)

Choose Remix as your framework preset and then click on deploy!

![deploy](https://us-east-1.tixte.net/uploads/toshiki.needs.rest/brave_uyJ35KjqN3.png)
...
Code for this tutorial: [toshiki/remix-blog](https://github.com/toshiki/remix-blog)
